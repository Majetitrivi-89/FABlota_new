        ...
        <div className="container mx-auto max-w-2xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground mt-2">Join India's premium B2B fashion marketplace as a Retailer</p>
            </div>

            <Card variant="glass" className="border-border/50">
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl text-center">Retailer Registration</CardTitle>
                <CardDescription className="text-center">Create your shop account to buy products</CardDescription>
              </CardHeader>
              ...
              <CardContent>
                <div className="flex justify-center mb-8">
                  <div className="p-4 rounded-xl border-2 border-primary bg-primary/10">
                    ...
                    <p className="font-semibold text-primary">Retailer</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="businessName" placeholder="Your Shop Name" value={formData.businessName} onChange={(e) => setFormData({ ...formData, businessName: e.target.value })} required />
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="email" type="email" placeholder="shop@email.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required />
                  ...
                  <div className="space-y-4">
                    <h3 className="font-serif text-lg font-semibold text-primary border-b border-border pb-2">Shop Address</h3>
                    <div className="space-y-2">
                  ...
                  <Button type="submit" variant="hero" size="lg" className="w-full" disabled={isLoading}>
                    {isLoading ? (
                      ...
                      <>Create Retailer Account <ArrowRight className="h-4 w-4" /></>
                    )}
                  </Button>
                </form>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-muted-foreground">
                    Already have an account? <Link to="/retailer/login" className="text-primary font-medium hover:underline">Sign In</Link>
                  </p>
                </div>
              </CardContent>
            </Card>
